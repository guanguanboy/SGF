...
elif args.dataset=='SID':
    yaml_file = '/data/liguanlin/codes/MIRNetv2/Enhancement/Options/Enhancement_MIRNet_v2_SID.yml'
    weights = '/data/liguanlin/codes/MIRNetv2/Enhancement/pretrained_models/enhancement_sid.pth'    
else: 
